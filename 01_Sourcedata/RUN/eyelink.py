...
class TrackerEyeLink():
    def __init__(self,
        ...
        self.tracker.sendMessage("DISPLAY_COORDS  0 0 %d %d"
                                 %( tuple(self.screenSize)))
        self.tracker.sendCommand("calibration_area_proportion = {} {}".format(*calibrationArea))
        self.tracker.sendMessage("CALIBRATION_AREA {} {}".format(*calibrationArea))
        self.tracker.sendCommand("validation_area_proportion = {} {}".format(*validationArea))
        self.tracker.sendMessage("VALIDATION_AREA {} {}".format(*validationArea))
        self.tracker.setCalibrationType(calibrationType)
        self.tracker.sendMessage("CALIBRATION_TYPE {}".format(calibrationType))
    ...
    def _pix2(self, pixels, unit = None):
        ...
        if unit == 'pix':
            return pixels
        if unit == 'cm':
            return misc.pix2cm(pixels, self.monitor)
        if unit == 'deg':
            return misc.pix2deg(pixels, self.monitor)
